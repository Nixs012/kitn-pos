            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-brand-green/5 p-6 rounded-3xl border border-brand-green/10 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-black text-brand-dark tracking-tighter">{selectedCustomer.total_purchases?.toLocaleString()} KES</p>
                </div>
              </div>
              <div className="bg-brand-blue/5 p-6 rounded-3xl border border-brand-blue/10 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-black text-brand-dark tracking-tighter">{new Date(selectedCustomer.last_purchase!).toLocaleDateString()}</p>
                </div>
              </div>
